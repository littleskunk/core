...
StorageItem.prototype._init = function(data) {
  ...
  this.downloadable = data.downloadable || null;
  this.uploaded = data.uploaded || null;
  this.mirrored = data.mirrored || null;
  this.cleared = data.cleared || null;
  this.downloads = data.downloads || 0;
  this.mirrors = data.mirrors || 0;
  this.downloadcount = data.downloadcount || 0;
  this.headercount = data.headercount || 0;
  this.mirrorcount = data.mirrorcount || 0;
