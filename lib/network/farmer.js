...
FarmerInterface.prototype.getPaymentAddress = function() {
  if (this._options.paymentAddressList) {
    return this._options.paymentAddressList[Math.floor(Math.random()*this._options.paymentAddressList.length)];
  } else {
...
FarmerInterface.prototype._shouldSendOffer = function(contract, callback) {
  ...
  this._negotiator.call(this, contract, function(shouldNegotiate) {
    ...
    return callback((self._pendingOffers.length < self._options.maxOfferConcurrency) && shouldNegotiate);
